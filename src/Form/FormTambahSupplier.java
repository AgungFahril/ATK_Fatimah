...
public class FormTambahSupplier extends javax.swing.JDialog {
    ...
    String telepon = text_notelepon.getText();
    String alamat = text_alamat.getText();
    String pemilik = text_namapemilik.getText();

    if (nama.isEmpty() || telepon.isEmpty() || alamat.isEmpty() || pemilik.isEmpty()) {
